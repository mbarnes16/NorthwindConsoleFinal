...
namespace NorthwindConsole2.Model
{
    public partial class NWConsole_96_MLBContext : DbContext
    {
        public NWConsole_96_MLBContext()
        {
        }

        public NWConsole_96_MLBContext(DbContextOptions<NWConsole_96_MLBContext> options)
            : base(options)
        {
        }
